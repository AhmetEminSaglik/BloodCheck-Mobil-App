enum EnumFcmMessageReason {
  ...
  static String getReasonOfCode(int code){
    switch(code){
      ...
      case 1000: return EnumFcmMessageReason.UPDATE_LINE_CHART.reason;
      case 1001: return EnumFcmMessageReason.UPDATE_SENSOR_TIMER.reason;
  ...
  static int getCodeOfReason(String reason){
    switch(reason){
      ...
      case "Update Sensor Timer": return EnumFcmMessageReason.UPDATE_SENSOR_TIMER.code;
      default: return -1;
                  }
      }
